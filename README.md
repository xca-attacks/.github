...
### Breaking AMD SEV-SNP via Hardware Interconnect Manipulation
...
<img src="hugo/static/preview.png" width="800px" style="border-radius: 10px; margin: 20px 0;">
...
**XCA (Interconnect Corruption Attacks)** is a family of hardware-based vulnerabilities targeting Trusted Execution Environments (TEEs), specifically **AMD SEV-SNP**. 

We exploit the gap between performance-oriented interconnect design and security requirements. By manipulating the **System Management Network (SMN)** and **Infinity Fabric**, an untrusted hypervisor or BIOS can silently redirect, suppress, or intercept security-critical transactions, undermining the protections enforced by the Platform Security Processor (PSP).
...
<table align="center" border="0">
  <tr>
    <td align="center" width="50%" style="vertical-align: top;">
      <img src="hugo/static/Fabricked-symbol.svg" width="220px"><br>
      <h3><b>Fabricked</b></h3>
    ...
    <td align="center" width="50%" style="vertical-align: top;">
      <img src="hugo/static/BreakFast-symbol.svg" width="220px"><br>
      <h3><b>BreakFAST</b></h3>
...
For more technical details and animations, visit our project website:  
